...
- **Utilities** (`web/src/utils/`): import the shared `formatLapTime`, `toTopPercent` /
  `topPercentLabel`, `deriveAlerts`, `breadcrumbs`, `raceWeekNumber` / `raceWeekLabel`, `splitLabel` — **don't**
