...
public class WeekCarStatsServiceTests
{
    ...
    public async Task GetCarsForWeekAsync_WeekNotInSeries_ReturnsEmpty()
    {
        ...
        var result = await new WeekCarStatsService(db).GetCarsForWeekAsync(seriesId: 99, weekId: 10);
    ...
    public async Task GetCarsForWeekAsync_OddLapCount_ReturnsMiddleValueAsMedian()
    {
        ...
        db.LapTimeEntries.AddRange(
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 1, LapTimeSeconds = 60, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 2, LapTimeSeconds = 70, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 3, LapTimeSeconds = 90, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow });
        await db.SaveChangesAsync();

        var result = await new WeekCarStatsService(db).GetCarsForWeekAsync(seriesId: 1, weekId: 10);
    ...
    public async Task GetCarsForWeekAsync_EvenLapCount_ReturnsAverageOfTwoMiddleValuesAsMedian()
    {
        ...
        db.LapTimeEntries.AddRange(
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 1, LapTimeSeconds = 60, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 2, LapTimeSeconds = 70, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 3, LapTimeSeconds = 80, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 4, LapTimeSeconds = 90, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow });
        await db.SaveChangesAsync();
    ...
    public async Task GetCarsForWeekAsync_MultipleCars_OrderedByFastestLapAscending()
    {
        ...
        db.Cars.Add(car2);
        db.LapTimeEntries.AddRange(
            new LapTimeEntry { WeekId = 10, CarId = 1, DriverCustomerId = 1, LapTimeSeconds = 70, Car = car, Week = week, RecordedAt = DateTimeOffset.UtcNow },
            new LapTimeEntry { WeekId = 10, CarId = 2, DriverCustomerId = 2, LapTimeSeconds = 60, Car = car2, Week = week, RecordedAt = DateTimeOffset.UtcNow });
        await db.SaveChangesAsync();
