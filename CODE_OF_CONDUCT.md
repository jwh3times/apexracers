...
- **Failing to credit sources.** Not properly crediting the sources of content
  you contribute.
- **Promotional materials.** Sharing marketing or other commercial content in a
...
> **Note:** This channel is for Code of Conduct concerns only. To report a
> **security vulnerability**, do not use this address or open a public issue —
> follow the private process in [SECURITY.md](SECURITY.md) instead.

ApexRacers is maintained by a single developer, who acts as the sole Community
Moderator for the purposes of this document. Reports are taken seriously and will
receive a response in a timely manner. The maintainer will investigate all
reports — reviewing messages, logs, and recordings, or interviewing witnesses and
other participants — and will keep investigation and enforcement actions as
transparent as possible while prioritizing safety and confidentiality. Enforcement
actions are carried out in private with the involved parties, but communicating to
...
based on the incident's impact on the individuals involved and the community as a
